...
//Act 
cy.get('[data-cy="name-input"]').type("Nida")
cy.get('[data-cy="surname-input"]').type("Türkay")
cy.get('[data-cy="email-input"]').type("nida@wit.com.tr")
cy.get('[data-cy="password-input"]').type("Aa..12345*");
